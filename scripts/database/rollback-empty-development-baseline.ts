...
const CYCLIC_CURRENT_EVENT_FOREIGN_KEYS = [
  {
    tableName: "buyer_organizations",
    constraintName: "buyer_org_current_verification_event_fk",
  },
  {
    tableName: "buyer_tax_identifiers",
    constraintName: "buyer_tax_trusted_event_fk",
  },
  {
    tableName: "buyer_registry_identifiers",
    constraintName: "buyer_registry_trusted_event_fk",
  },
  {
    ...
    PRODUCTION_FINGERPRINT[tableName].constraints
      .filter((constraint) =>
        ...
        (constraint.definition.includes("REFERENCES seller_verification_events(id)") ||
          constraint.definition.includes("REFERENCES buyer_organization_verification_events(id"))
      )
