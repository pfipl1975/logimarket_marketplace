...
export const EXPECTED_POST_0018_TABLES = [
  ...EXPECTED_POST_0015_TABLES,
  "buyer_organizations",
...
export const RUNTIME_ENV_VARS = [
  ...
  "RUNTIME_MIGRATION_EXPECTED_PRE_STATE",
...
export type RuntimeSecurityContract = {
  ...
  preventBuyerOrganizationVerificationEventsMutationSearchPath?: string[] | null;
};
...
export const PRE_0008_SECURITY_CONTRACT: RuntimeSecurityContract = {
  ...
  preventBuyerOrganizationVerificationEventsMutationSearchPath: null,
};
...
export const POST_0018_SECURITY_CONTRACT: RuntimeSecurityContract = {
  ...POST_0009_SECURITY_CONTRACT,
  preventBuyerOrganizationVerificationEventsMutationSearchPath: ['search_path=""'],
};
...
export const FINAL_POST_0017_PRODUCTION_FINGERPRINT: Record<string, TableContract> = {
  ...FINAL_POST_0016_PRODUCTION_FINGERPRINT,
  "offers": {
    ...FINAL_POST_0016_PRODUCTION_FINGERPRINT["offers"],
    constraints: FINAL_POST_0016_PRODUCTION_FINGERPRINT["offers"].constraints.map(c => 
      c.name === "offers_publication_status_check"
        ? { name: "offers_publication_status_check", type: "CHECK", definition: "CHECK (((publication_status)::text = ANY ((ARRAY['draft'::character varying, 'pending_review'::character varying, 'published'::character varying, 'hidden'::character varying, 'archived'::character varying, 'deleted'::character varying])::text[])))" }
        : c
    )
  }
};

export const FINAL_POST_0018_PRODUCTION_FINGERPRINT: Record<string, TableContract> = {
  ...FINAL_POST_0017_PRODUCTION_FINGERPRINT,
  "buyer_organizations": {
    name: "buyer_organizations",
    columns: [
      { name: "id", type: "bigint", nullable: false, defaultVal: "nextval('buyer_organizations_id_seq'::regclass)", sequenceName: "buyer_organizations_id_seq" },
      { name: "legal_name", type: "character varying(255)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "jurisdiction_country", type: "character varying(2)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "verification_status", type: "character varying(20)", nullable: false, defaultVal: "'pending'::character varying", sequenceName: null },
      { name: "current_verification_event_id", type: "bigint", nullable: true, defaultVal: null, sequenceName: null },
      { name: "verified_at", type: "timestamp with time zone", nullable: true, defaultVal: null, sequenceName: null },
      { name: "created_at", type: "timestamp with time zone", nullable: false, defaultVal: "now()", sequenceName: null },
      { name: "updated_at", type: "timestamp with time zone", nullable: true, defaultVal: null, sequenceName: null },
    ...
    constraints: [
      { name: "buyer_organizations_pkey", type: "PRIMARY KEY", definition: "PRIMARY KEY (id)" },
      { name: "buyer_org_current_verification_event_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (current_verification_event_id, id) REFERENCES buyer_organization_verification_events(id, buyer_organization_id) ON DELETE RESTRICT" },
      { name: "chk_buyer_organizations_country", type: "CHECK", definition: "CHECK (((jurisdiction_country)::text ~ '^[A-Z]{2}$'::text))" },
      { name: "chk_buyer_organizations_verification_status", type: "CHECK", definition: "CHECK (((verification_status)::text = ANY ((ARRAY['pending'::character varying, 'verified'::character varying, 'rejected'::character varying, 'revoked'::character varying])::text[])))" },
      { name: "chk_buyer_organizations_verification_consistency", type: "CHECK", definition: "CHECK (((((verification_status)::text = 'verified'::text) AND (current_verification_event_id IS NOT NULL) AND (verified_at IS NOT NULL)) OR (((verification_status)::text = 'pending'::text) AND (verified_at IS NULL)) OR (((verification_status)::text = ANY ((ARRAY['rejected'::character varying, 'revoked'::character varying])::text[])) AND (current_verification_event_id IS NOT NULL) AND (verified_at IS NULL))))" },
    ],
    explicitIndexes: [
      { name: "idx_buyer_organizations_verification_status", method: "btree", expressions: "verification_status" },
    ],
    rlsEnabled: true,
    policyCount: 0,
    triggerCount: 0,
  ...
  "buyer_organization_memberships": {
    name: "buyer_organization_memberships",
    columns: [
      { name: "id", type: "bigint", nullable: false, defaultVal: "nextval('buyer_organization_memberships_id_seq'::regclass)", sequenceName: "buyer_organization_memberships_id_seq" },
      { name: "auth_user_id", type: "uuid", nullable: false, defaultVal: null, sequenceName: null },
      { name: "buyer_organization_id", type: "bigint", nullable: false, defaultVal: null, sequenceName: null },
      { name: "membership_role", type: "character varying(30)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "membership_status", type: "character varying(20)", nullable: false, defaultVal: "'active'::character varying", sequenceName: null },
      { name: "ended_at", type: "timestamp with time zone", nullable: true, defaultVal: null, sequenceName: null },
      { name: "created_at", type: "timestamp with time zone", nullable: false, defaultVal: "now()", sequenceName: null },
      { name: "updated_at", type: "timestamp with time zone", nullable: true, defaultVal: null, sequenceName: null },
    ],
    constraints: [
      { name: "buyer_organization_memberships_pkey", type: "PRIMARY KEY", definition: "PRIMARY KEY (id)" },
      { name: "buyer_organization_memberships_organization_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (buyer_organization_id) REFERENCES buyer_organizations(id) ON DELETE RESTRICT" },
      { name: "uq_buyer_organization_membership", type: "UNIQUE", definition: "UNIQUE (auth_user_id, buyer_organization_id)" },
      { name: "chk_buyer_organization_membership_role", type: "CHECK", definition: "CHECK (((membership_role)::text = ANY ((ARRAY['organization_admin'::character varying, 'authorized_buyer'::character varying])::text[])))" },
      { name: "chk_buyer_organization_membership_status", type: "CHECK", definition: "CHECK (((membership_status)::text = ANY ((ARRAY['active'::character varying, 'inactive'::character varying, 'revoked'::character varying])::text[])))" },
      { name: "chk_buyer_organization_membership_consistency", type: "CHECK", definition: "CHECK (((((membership_status)::text = 'active'::text) AND (ended_at IS NULL)) OR (((membership_status)::text = ANY ((ARRAY['inactive'::character varying, 'revoked'::character varying])::text[])) AND (ended_at IS NOT NULL))))" },
    ],
    explicitIndexes: [
      { name: "idx_buyer_memberships_auth_status", method: "btree", expressions: "auth_user_id, membership_status" },
      { name: "idx_buyer_memberships_org_status", method: "btree", expressions: "buyer_organization_id, membership_status" },
    ],
    rlsEnabled: true,
    policyCount: 0,
    triggerCount: 0,
  ...
  "buyer_tax_identifiers": {
    name: "buyer_tax_identifiers",
    columns: [
      { name: "id", type: "bigint", nullable: false, defaultVal: "nextval('buyer_tax_identifiers_id_seq'::regclass)", sequenceName: "buyer_tax_identifiers_id_seq" },
      { name: "buyer_organization_id", type: "bigint", nullable: false, defaultVal: null, sequenceName: null },
      { name: "identifier_type", type: "character varying(50)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "identifier_value", type: "character varying(100)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "country_code", type: "character varying(2)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "canonical_identity_class", type: "character varying(50)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "canonical_identifier_value", type: "character varying(100)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "trusted_by_verification_event_id", type: "bigint", nullable: true, defaultVal: null, sequenceName: null },
      { name: "created_at", type: "timestamp with time zone", nullable: false, defaultVal: "now()", sequenceName: null },
      { name: "retired_at", type: "timestamp with time zone", nullable: true, defaultVal: null, sequenceName: null },
    ],
    constraints: [
      { name: "buyer_tax_identifiers_pkey", type: "PRIMARY KEY", definition: "PRIMARY KEY (id)" },
      { name: "buyer_tax_identifiers_organization_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (buyer_organization_id) REFERENCES buyer_organizations(id) ON DELETE RESTRICT" },
      { name: "buyer_tax_trusted_event_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (trusted_by_verification_event_id, buyer_organization_id) REFERENCES buyer_organization_verification_events(id, buyer_organization_id) ON DELETE RESTRICT" },
      { name: "uq_buyer_tax_identifier_owner", type: "UNIQUE", definition: "UNIQUE (id, buyer_organization_id)" },
      { name: "uq_buyer_tax_identifier_identity", type: "UNIQUE", definition: "UNIQUE (buyer_organization_id, identifier_type, country_code, identifier_value)" },
      { name: "chk_buyer_tax_identifier_type", type: "CHECK", definition: "CHECK (((identifier_type)::text = ANY ((ARRAY['tax_id'::character varying, 'vat_id'::character varying])::text[])))" },
      { name: "chk_buyer_tax_identifier_country", type: "CHECK", definition: "CHECK (((country_code)::text ~ '^[A-Z]{2}$'::text))" },
      { name: "chk_buyer_tax_identifier_value", type: "CHECK", definition: "CHECK ((length(btrim((identifier_value)::text)) > 0))" },
      { name: "chk_buyer_tax_identifier_trust_retirement", type: "CHECK", definition: "CHECK (((trusted_by_verification_event_id IS NULL) OR (retired_at IS NULL)))" },
    ],
    explicitIndexes: [
      { name: "idx_buyer_tax_identifiers_active_org", method: "btree", expressions: "buyer_organization_id" },
      { name: "idx_buyer_tax_identifiers_active_canonical", method: "btree", expressions: "canonical_identity_class, canonical_identifier_value" },
    ],
    rlsEnabled: true,
    policyCount: 0,
    triggerCount: 0,
  ...
  "buyer_registry_identifiers": {
    name: "buyer_registry_identifiers",
    columns: [
      { name: "id", type: "bigint", nullable: false, defaultVal: "nextval('buyer_registry_identifiers_id_seq'::regclass)", sequenceName: "buyer_registry_identifiers_id_seq" },
      { name: "buyer_organization_id", type: "bigint", nullable: false, defaultVal: null, sequenceName: null },
      { name: "registry_type", type: "character varying(50)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "registry_value", type: "character varying(100)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "jurisdiction_country", type: "character varying(2)", nullable: false, defaultVal: null, sequenceName: null },
    ...
    constraints: [
      { name: "buyer_registry_identifiers_pkey", type: "PRIMARY KEY", definition: "PRIMARY KEY (id)" },
      { name: "buyer_registry_identifiers_organization_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (buyer_organization_id) REFERENCES buyer_organizations(id) ON DELETE RESTRICT" },
      { name: "buyer_registry_trusted_event_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (trusted_by_verification_event_id, buyer_organization_id) REFERENCES buyer_organization_verification_events(id, buyer_organization_id) ON DELETE RESTRICT" },
      { name: "uq_buyer_registry_identifier_owner", type: "UNIQUE", definition: "UNIQUE (id, buyer_organization_id)" },
      { name: "uq_buyer_registry_identifier_identity", type: "UNIQUE", definition: "UNIQUE (buyer_organization_id, registry_type, jurisdiction_country, registry_value)" },
      { name: "chk_buyer_registry_identifier_type", type: "CHECK", definition: "CHECK (((registry_type)::text = ANY ((ARRAY['commercial_register'::character varying, 'statistical_id'::character varying])::text[])))" },
      { name: "chk_buyer_registry_identifier_country", type: "CHECK", definition: "CHECK (((jurisdiction_country)::text ~ '^[A-Z]{2}$'::text))" },
      { name: "chk_buyer_registry_identifier_value", type: "CHECK", definition: "CHECK ((length(btrim((registry_value)::text)) > 0))" },
      { name: "chk_buyer_registry_identifier_trust_retirement", type: "CHECK", definition: "CHECK (((trusted_by_verification_event_id IS NULL) OR (retired_at IS NULL)))" },
    ],
    explicitIndexes: [
      { name: "idx_buyer_registry_identifiers_active_org", method: "btree", expressions: "buyer_organization_id" },
      { name: "idx_buyer_registry_identifiers_active_value", method: "btree", expressions: "registry_type, jurisdiction_country, registry_value" },
    ],
    rlsEnabled: true,
    policyCount: 0,
    triggerCount: 0,
  ...
  "buyer_organization_verification_events": {
    name: "buyer_organization_verification_events",
    columns: [
      { name: "id", type: "bigint", nullable: false, defaultVal: "nextval('buyer_organization_verification_events_id_seq'::regclass)", sequenceName: "buyer_organization_verification_events_id_seq" },
      { name: "buyer_organization_id", type: "bigint", nullable: false, defaultVal: null, sequenceName: null },
      { name: "event_type", type: "character varying(30)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "outcome_status", type: "character varying(20)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "actor_type", type: "character varying(30)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "actor_user_id", type: "uuid", nullable: true, defaultVal: null, sequenceName: null },
      { name: "source_type", type: "character varying(30)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "source_name", type: "character varying(100)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "source_reference", type: "text", nullable: true, defaultVal: null, sequenceName: null },
      { name: "verification_method", type: "character varying(100)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "reason_code", type: "character varying(100)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "previous_verification_status", type: "character varying(20)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "legal_name_snapshot", type: "character varying(255)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "jurisdiction_country_snapshot", type: "character varying(2)", nullable: false, defaultVal: null, sequenceName: null },
      { name: "tax_identifier_id", type: "bigint", nullable: true, defaultVal: null, sequenceName: null },
      { name: "tax_identifier_type_snapshot", type: "character varying(50)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "tax_identifier_value_snapshot", type: "character varying(100)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "tax_country_code_snapshot", type: "character varying(2)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "registry_identifier_id", type: "bigint", nullable: true, defaultVal: null, sequenceName: null },
      { name: "registry_type_snapshot", type: "character varying(50)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "registry_value_snapshot", type: "character varying(100)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "registry_country_code_snapshot", type: "character varying(2)", nullable: true, defaultVal: null, sequenceName: null },
      { name: "occurred_at", type: "timestamp with time zone", nullable: false, defaultVal: "now()", sequenceName: null },
    ],
    constraints: [
      { name: "buyer_organization_verification_events_pkey", type: "PRIMARY KEY", definition: "PRIMARY KEY (id)" },
      { name: "buyer_verification_events_organization_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (buyer_organization_id) REFERENCES buyer_organizations(id) ON DELETE RESTRICT" },
      { name: "buyer_verification_events_tax_owner_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (tax_identifier_id, buyer_organization_id) REFERENCES buyer_tax_identifiers(id, buyer_organization_id) ON DELETE RESTRICT" },
      { name: "buyer_verification_events_registry_owner_fk", type: "FOREIGN KEY", definition: "FOREIGN KEY (registry_identifier_id, buyer_organization_id) REFERENCES buyer_registry_identifiers(id, buyer_organization_id) ON DELETE RESTRICT" },
      { name: "uq_buyer_verification_event_owner", type: "UNIQUE", definition: "UNIQUE (id, buyer_organization_id)" },
      { name: "chk_buyer_verification_event_type", type: "CHECK", definition: "CHECK (((event_type)::text = ANY ((ARRAY['verified'::character varying, 'rejected'::character varying, 'revoked'::character varying, 'invalidated'::character varying])::text[])))" },
      { name: "chk_buyer_verification_outcome_status", type: "CHECK", definition: "CHECK (((outcome_status)::text = ANY ((ARRAY['pending'::character varying, 'verified'::character varying, 'rejected'::character varying, 'revoked'::character varying])::text[])))" },
      { name: "chk_buyer_verification_previous_status", type: "CHECK", definition: "CHECK (((previous_verification_status)::text = ANY ((ARRAY['pending'::character varying, 'verified'::character varying, 'rejected'::character varying, 'revoked'::character varying])::text[])))" },
      { name: "chk_buyer_verification_event_outcome", type: "CHECK", definition: "CHECK (((((event_type)::text = 'verified'::text) AND ((outcome_status)::text = 'verified'::text)) OR (((event_type)::text = 'rejected'::text) AND ((outcome_status)::text = 'rejected'::text)) OR (((event_type)::text = 'revoked'::text) AND ((outcome_status)::text = 'revoked'::text)) OR (((event_type)::text = 'invalidated'::text) AND ((outcome_status)::text = 'pending'::text))))" },
      { name: "chk_buyer_verification_actor_type", type: "CHECK", definition: "CHECK (((actor_type)::text = ANY ((ARRAY['admin'::character varying, 'buyer_user'::character varying, 'system'::character varying, 'external_adapter'::character varying])::text[])))" },
      { name: "chk_buyer_verification_source_type", type: "CHECK", definition: "CHECK (((source_type)::text = ANY ((ARRAY['admin_manual'::character varying, 'buyer_change'::character varying, 'system_rule'::character varying, 'external_adapter'::character varying])::text[])))" },
      { name: "chk_buyer_verification_actor", type: "CHECK", definition: "CHECK (((((actor_type)::text = ANY ((ARRAY['admin'::character varying, 'buyer_user'::character varying])::text[])) AND (actor_user_id IS NOT NULL)) OR (((actor_type)::text = ANY ((ARRAY['system'::character varying, 'external_adapter'::character varying])::text[])) AND (actor_user_id IS NULL))))" },
      { name: "chk_buyer_verification_source_actor", type: "CHECK", definition: "CHECK (((((source_type)::text = 'admin_manual'::text) AND ((actor_type)::text = 'admin'::text)) OR (((source_type)::text = 'buyer_change'::text) AND ((actor_type)::text = 'buyer_user'::text)) OR (((source_type)::text = 'system_rule'::text) AND ((actor_type)::text = 'system'::text)) OR (((source_type)::text = 'external_adapter'::text) AND ((actor_type)::text = 'external_adapter'::text))))" },
      { name: "chk_buyer_verification_tax_snapshot", type: "CHECK", definition: "CHECK ((((tax_identifier_id IS NULL) AND (tax_identifier_type_snapshot IS NULL) AND (tax_identifier_value_snapshot IS NULL) AND (tax_country_code_snapshot IS NULL)) OR ((tax_identifier_id IS NOT NULL) AND (tax_identifier_type_snapshot IS NOT NULL) AND (tax_identifier_value_snapshot IS NOT NULL) AND (tax_country_code_snapshot IS NOT NULL))))" },
      { name: "chk_buyer_verification_registry_snapshot", type: "CHECK", definition: "CHECK ((((registry_identifier_id IS NULL) AND (registry_type_snapshot IS NULL) AND (registry_value_snapshot IS NULL) AND (registry_country_code_snapshot IS NULL)) OR ((registry_identifier_id IS NOT NULL) AND (registry_type_snapshot IS NOT NULL) AND (registry_value_snapshot IS NOT NULL) AND (registry_country_code_snapshot IS NOT NULL))))" },
      { name: "chk_buyer_verification_identifier_present", type: "CHECK", definition: "CHECK (((tax_identifier_id IS NOT NULL) OR (registry_identifier_id IS NOT NULL)))" },
      { name: "chk_buyer_verification_evidence", type: "CHECK", definition: "CHECK ((((event_type)::text <> 'verified'::text) OR ((length(btrim((source_name)::text)) > 0) AND (length(btrim(source_reference)) > 0))))" },
      { name: "chk_buyer_verification_reason", type: "CHECK", definition: "CHECK ((((event_type)::text = 'verified'::text) OR (length(btrim((reason_code)::text)) > 0)))" },
      { name: "chk_buyer_verification_country", type: "CHECK", definition: "CHECK (((jurisdiction_country_snapshot)::text ~ '^[A-Z]{2}$'::text))" },
    ],
    explicitIndexes: [
      { name: "idx_buyer_verification_events_org_time", method: "btree", expressions: "buyer_organization_id, occurred_at" },
      { name: "idx_buyer_verification_events_type_time", method: "btree", expressions: "event_type, occurred_at" },
      { name: "idx_buyer_verification_events_tax", method: "btree", expressions: "tax_identifier_id" },
      { name: "idx_buyer_verification_events_registry", method: "btree", expressions: "registry_identifier_id" },
    ],
    rlsEnabled: true,
    policyCount: 0,
    triggerCount: 1,
