...
Notes:
- `NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED`: The complete normative target representation/lifecycle has not yet been implemented. Existing current repository mappings may already exist and remain authoritative current facts.
- `PHYSICAL_IMPLEMENTATION_STATUS` refers to the FULL NORMATIVE TARGET LIFECYCLE, not whether any current table/status workflow exists.
...
- PHYSICAL_IMPLEMENTATION_STATUS: NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED
...
## 2C. OfferSellerAssignment lifecycle
- LIFECYCLE_ID: LC-02C
- SUBJECT: OfferSellerAssignment
- INDEPENDENT_FROM_CONVERSION_MODEL_LIFECYCLE: YES
- INDEPENDENT_FROM_CONTRACT_MODEL_LIFECYCLE: YES
- NOTE: Changing seller assignment must not automatically change offerModel or contractModel. SELLER_ASSIGNMENT_LIFECYCLE_INDEPENDENT=YES; CROSS_AXIS_AUTOMATIC_TRANSITIONS=0
- INITIAL_STATE: draft_assignment
- NON_TERMINAL_STATES: active_assignment, suspended_assignment
- TERMINAL_STATES: historical_assignment
- ALLOWED_TRANSITIONS:
  draft_assignment -> active_assignment
  active_assignment -> suspended_assignment
  suspended_assignment -> active_assignment
  active_assignment -> historical_assignment
  suspended_assignment -> historical_assignment
- REJECTED_TRANSITIONS: historical_assignment -> active_assignment
- TRANSITION_OWNER: LogiMarket
- IDEMPOTENCY_REQUIREMENT: REQUIRED
- AUDIT_REQUIREMENT: REQUIRED
- OPEN_MODEL_QUESTION_DEPENDENCY: NONE
...
- NOTE: partner_responded is a terminal state that records the existence of a RfqPartnerResponse. It does NOT imply contract formation. RFQ_NONBINDING_BY_DEFAULT=YES. No SellerOrder or payment created.
- TRANSITION_OWNER: System (Platform Orchestration)
- IDEMPOTENCY_REQUIREMENT: REQUIRED
- AUDIT_REQUIREMENT: REQUIRED
- OPEN_MODEL_QUESTION_DEPENDENCY: OMQ-MKT-02 (RFQ_NONBINDING_BY_DEFAULT=YES — mapped to RfqRequest and RfqPartnerResponse)
- PHYSICAL_IMPLEMENTATION_STATUS: NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED
...
- IDEMPOTENCY_REQUIREMENT: REQUIRED
- AUDIT_REQUIREMENT: REQUIRED
- OPEN_MODEL_QUESTION_DEPENDENCY: OMQ-MKT-01 (E7=EXPLICIT_PARTNER_ACCEPTANCE)
- PHYSICAL_IMPLEMENTATION_STATUS: NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED
...
- SCOPE: E-COMMERCE_FLOW_ONLY (CANONICAL_OFFER_MODEL=ecommerce)
...
- IDEMPOTENCY_REQUIREMENT: REQUIRED
- AUDIT_REQUIREMENT: REQUIRED
- OPEN_MODEL_QUESTION_DEPENDENCY: OMQ-MKT-01 (E7=EXPLICIT_PARTNER_ACCEPTANCE — e-commerce only)
- PHYSICAL_IMPLEMENTATION_STATUS: NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED
...
- CHARGEBACK_FINANCIAL_ALLOCATION_OWNER: UNRESOLVED
...
- IDEMPOTENCY_REQUIREMENT: REQUIRED
- AUDIT_REQUIREMENT: REQUIRED
- OPEN_MODEL_QUESTION_DEPENDENCY: OMQ-MKT-02 (RFQ_NONBINDING_BY_DEFAULT=YES)
- PHYSICAL_IMPLEMENTATION_STATUS: NORMATIVE_TARGET_NOT_FULLY_IMPLEMENTED
