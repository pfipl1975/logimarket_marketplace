...
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
...
* **OWNER_PROPOSED_RESOLUTION**: RETURN_DESTINATION=SUPPLIER_WAREHOUSE; RETURN_AUTHORISATION_REQUIRED=YES; RETURN_COST_ALLOCATION=CAUSE_BASED
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Opinia prawna
* **EVIDENCE_OWNER**: Legal Counsel
...
* **BLOCKED_SPRINTS**: LM-DROP-SCHEMA-56B4
* **APPROVAL_EVIDENCE_FORMAT**: Formalna Opinia (PDF)
* **OWNER_PROPOSED_RESOLUTION**: FIRST_LINE_SUPPORT=LOGIMARKET; SUPPLIER_TECHNICAL_ESCALATION=YES; CUSTOMER_FACING_FORMAL_PROCESS=LOGIMARKET
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Opinia prawna
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-SCHEMA-56B4
...
* **APPROVAL_EVIDENCE_FORMAT**: Formalna Opinia (PDF)
* **OWNER_PROPOSED_RESOLUTION**: DELIVERY_TERM=DAP_NAMED_PLACE_INCOTERMS_2020
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Opinia prawna
* **EVIDENCE_OWNER**: Legal Counsel
...
* **OWNER_PROPOSED_RESOLUTION**: DPA w T&C platformy
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Umowa powierzenia
* **EVIDENCE_OWNER**: Legal Counsel
...
* **OWNER_PROPOSED_RESOLUTION**: 5 lat podatkowych
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Polityka retencji
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-SCHEMA-56B5
...
* **APPROVAL_EVIDENCE_FORMAT**: Formalna Opinia (PDF)
* **OWNER_PROPOSED_RESOLUTION**: SUPPLIER_RECOURSE=CONDITIONAL_ON_CAUSE_AND_CONTRACT
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Opinia prawna
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-SCHEMA-56B3
...
* **APPROVAL_EVIDENCE_FORMAT**: Formalna Opinia (PDF)
* **OWNER_PROPOSED_RESOLUTION**: PAYMENT_TO_LOGIMARKET_OPERATING_OR_PSP_SETTLEMENT_ACCOUNT
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Opinia prawna
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-SCHEMA-56B3, LM-DROP-PAYMENT-56E
...
* **OWNER_PROPOSED_RESOLUTION**: CUSTOMER_REFUND_EXECUTOR=LOGIMARKET; ADMIN_MVP_REFUND_CONTROL=CENTRALISED
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Procedura refundacji
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-SCHEMA-56B3, LM-DROP-SCHEMA-56B4, LM-DROP-PAYMENT-56E, LM-DROP-RETURNS-56G
...
* **OWNER_PROPOSED_RESOLUTION**: INTERNAL_TRADE_CREDIT=NOT_IN_MVP; EXTERNAL_B2B_FINANCING=POST_MVP
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Umowa ramowa kredytu kupieckiego
* **EVIDENCE_OWNER**: Legal Counsel
...
* **OWNER_PROPOSED_RESOLUTION**: Wewnętrzne monity
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Procedura windykacyjna
* **EVIDENCE_OWNER**: Legal Counsel
* **BLOCKING_SCOPE**: LM-DROP-PAYMENT-56E
...
* **FORMAL_EVIDENCE_STATUS**: PENDING_EXTERNAL_REVIEW
* **REQUIRED_EXTERNAL_DELIVERABLE**: Regulamin plasowania ofert (P2B)
* **EVIDENCE_OWNER**: Legal Counsel
