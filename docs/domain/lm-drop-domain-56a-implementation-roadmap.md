...
| `CAP-DROP-SLA-05` | RAW_EVENT_CAPTURE | `FUTURE_OPTIONAL` | `MVP_REQUIRED` | NULL | NULL | `LM-DROP-SLA-57D` | NO |
...
| `CAP-DROP-SLA-05` | RANKING_INFLUENCE | `FUTURE_OPTIONAL` | `POST_MVP` | NULL | `LEG-GATE-14` | `LM-DROP-SLA-57D` | NO |
