...
## R2B OVERLAY
* CORRECTED PAYMENT STATE FLOW: Incorporated
* PRICE-ERROR FLOW: Incorporated
* DAP AND SUPPLIER-RECOURSE: Incorporated
* ECOMMERCE/RFQ INVARIANTS: Preserved
* SELECTED MVP VARIANTS: BUSINESS_OWNER_SELECTED
