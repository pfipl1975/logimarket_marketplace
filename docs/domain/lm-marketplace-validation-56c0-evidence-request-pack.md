...
- external review instruction:
  - External reviewers must identify whether applicable law, accounting rules, tax rules, privacy requirements, PSP terms, scheme rules or operational constraints invalidate, narrow or require modification of these assumptions.
- approved business-model assumptions and intended operating constraints:
  - LogiMarket is an intermediary for the partner marketplace.
  - Partners own commercial content and goods refund liability.
  - PSP integration must not involve self-custody or LogiMarket escrow.
...
- external review instruction:
  - External reviewers must identify whether applicable law, accounting rules, tax rules, privacy requirements, PSP terms, scheme rules or operational constraints invalidate, narrow or require modification of these assumptions.
- approved business-model assumptions and intended operating constraints:
  - LogiMarket issues platform-service invoices; Partners issue goods invoices.
...
- external review instruction:
  - External reviewers must identify whether applicable law, accounting rules, tax rules, privacy requirements, PSP terms, scheme rules or operational constraints invalidate, narrow or require modification of these assumptions.
- approved business-model assumptions and intended operating constraints:
  - No LogiMarket self-custody or operated escrow.
...
- external review instruction:
  - External reviewers must identify whether applicable law, accounting rules, tax rules, privacy requirements, PSP terms, scheme rules or operational constraints invalidate, narrow or require modification of these assumptions.
- approved business-model assumptions and intended operating constraints:
  - Configurable retention and abstract processing context.
...
- external review instruction:
  - External reviewers must identify whether applicable law, accounting rules, tax rules, privacy requirements, PSP terms, scheme rules or operational constraints invalidate, narrow or require modification of these assumptions.
- approved business-model assumptions and intended operating constraints:
  - Approved Logical Model Data semantics.
