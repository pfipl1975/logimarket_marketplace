  ...
  return (
    <form method="get" action={basePath} className="flex items-center gap-2">
      ...
      <select
        ...
        className="rounded border border-border bg-white px-3 py-1.5 text-sm text-brand-navy shadow-sm focus:border-brand-teal focus:outline-none focus:ring-1 focus:ring-brand-teal"
      >
      ...
      <button
        type="submit"
        className="rounded bg-brand-navy px-3 py-1.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-brand-teal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:ring-offset-2"
      >
        {labels.apply}
      </button>
    </form>
