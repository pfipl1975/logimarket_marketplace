...
export function CategoryAttributeFilters({ basePath, view, sort, filters, definitions, labels }: Props) {
  ...
  return (
    <aside className="mt-3 w-full rounded-lg border border-border bg-white p-3 shadow-sm sm:p-4">
      ...
      <details className="md:hidden">
        <summary className="flex min-h-11 cursor-pointer items-center text-sm font-bold text-brand-navy focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:ring-offset-2">{labels.summary}</summary>
