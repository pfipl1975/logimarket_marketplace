    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-brand-navy text-white shadow-sm">
      ...
      <div className="border-t border-white/10 bg-brand-navy">
        <div className="mx-auto w-full max-w-[1600px] relative">
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-3 py-1.5 sm:px-4 md:px-6 xl:gap-3 2xl:gap-4">
            ...
            <div className="hidden lg:flex shrink w-full min-w-[200px] max-w-[420px]">
            ...
            <div className="flex shrink-0 justify-end items-center gap-2 lg:gap-3">
              {navState.showLogin && navLabels.login && (
