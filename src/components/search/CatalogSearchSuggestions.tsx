  ...
  return (
    ...
    >
      <div className="group relative">
        <svg
          className="absolute left-3.5 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-brand-teal"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden="true"
        ...
        <input
          ...
          autoComplete="off"
          spellCheck={false}
          className="h-11 w-full rounded-md border border-white/25 bg-white px-10 text-sm text-brand-navy placeholder:text-brand-navy/55 focus:border-brand-teal focus:outline-none focus:ring-2 focus:ring-brand-teal focus:ring-offset-1 focus:ring-offset-brand-navy"
        />
        {query && (
          <button
            type="button"
            ...
            onClick={handleClear}
            className="absolute right-0 top-0 flex h-full min-h-11 min-w-11 items-center justify-center rounded-r-md text-brand-navy/60 transition-colors hover:text-brand-navy focus:outline-none focus:ring-2 focus:ring-brand-teal"
          >
      ...
      {isOpen && (
        <div
          className={cn(
            ...
            variant === "desktop"
              ? "absolute left-0 right-0 top-full z-[60] mt-1.5 max-h-[min(28rem,70vh)] overflow-y-auto rounded-md border shadow-lg"
