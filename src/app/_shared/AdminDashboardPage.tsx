      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow rounded-industrial p-6 border border-industrial">
          ...
          <div className="space-y-2 text-sm text-brand-navy">
            ...
            <Link href={`${routes.offers}?status=pending_review`} className="flex justify-between hover:text-brand-teal">
              <span>{dictOffers.statusPendingReview}</span>
              <span className="font-medium">{counts.offers.pendingReview}</span>
            </Link>
