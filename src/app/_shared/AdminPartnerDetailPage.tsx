...
export async function AdminPartnerDetailPage({
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto w-full pb-12">
      ...
      {/* Seller Readiness Section */}
      <section className={`bg-white rounded-industrial border border-border-industrial shadow-soft overflow-hidden ${result.data.readiness.status === 'ready' ? 'border-green-500' : 'border-red-500'}`}>
