...
export async function AdminOfferDetailPage({ id, locale }: AdminOfferDetailPageProps) {
  ...
  const getStatusLabel = (status: string) => {
    switch (status) {
      ...
      case "pending_review": return dict.statusPendingReview;
      ...
      <div className="space-y-6">
        ...
        <section className="bg-white rounded-industrial border border-border-industrial shadow-soft overflow-hidden">
          <div className="px-6 py-4 border-b border-border-industrial bg-brand-light-gray/30 flex items-center justify-between">
            ...
            {(offer.publicationStatus === "draft" || offer.publicationStatus === "pending_review" || offer.publicationStatus === "published") && (
